defmodule RomanNumerals do
  ...
  This solution begins by handling any 1000s digits, which then make a call to
  translate any 500s, which make a call to translate 100s, etc. It works in the
  following order:
  ...
  The `numeral/1` function takes a single number, and we use that to
  progressively build up a string that will contain the translated roman
  numeral.
  """
